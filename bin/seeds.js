//ESTE ARCHIVO NOS AYUDARÁ A POBLAR LA BASE DE DATOS o hacer seeds
// establecemos importaciones
...
//establecer los datos que queremos poblar
const books = [ 
    {
...
//en este caso es cracion de libros en la base de datos
const createBooksDB = async() =>{
    const newBooks = await Book.create(books)
    console.log(newBooks)
    mongoose.connection.close() //debemos cerrar la conexion a la base de datos
}
